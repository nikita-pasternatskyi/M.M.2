...
//thanks to https://github.com/MohitSethi99/SpringArmComponent/blob/main/Assets/SpringArm/Scripts/SpringArm.cs

#if UNITY_EDITOR
using UnityEditor;
#endif

namespace MykroFramework.Runtime.Objects.SpringArm
{
    ...
    public class SpringArm : MonoBehaviour
    {
        ...
        private void Rotate()
        {
            ...
            yaw += Input.GetAxisRaw("Mouse X") * mouseSensitivity * Time.unscaledDeltaTime;
            // Decrement pitch by Mouse Y input
            pitch -= Input.GetAxisRaw("Mouse Y") * mouseSensitivity * Time.unscaledDeltaTime;
