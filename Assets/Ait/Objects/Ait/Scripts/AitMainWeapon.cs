...
namespace Ait
{
    public class AitMainWeapon : Weapon
    {
        [SerializeField] private Projectile _normalShot;
        [SerializeField] private Projectile _middleChargeShot;
        [SerializeField] private Projectile _maxChargeShot;
